  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-lg text-gray-600 dark:text-gray-400">Loading blog posts...</div>
      </div>
    );
  }
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        {blogPosts.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-600 dark:text-gray-400">No blog posts found. Posts count: {blogPosts.length}</p>
          </div>
        ) : (
